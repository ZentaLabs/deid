...
- Add support for progress reporting [#302](https://github.com/pydicom/deid/pull/302) (0.4.13)
- Fix handle colons in private creator names for field expanders [#297](https://github.com/pydicom/deid/pull/297) (0.4.12)
